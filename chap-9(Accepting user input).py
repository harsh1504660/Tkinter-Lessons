...
def getvals():
    ...
    print(namevalue.get(),phonevalue.get(),gendervalue.get(),em_contactvalue.get(),payment_modevalue.get(),foodservice_value.get())
    with open('records.txt','a') as f:
        f.write(f"{namevalue.get(),phonevalue.get(),gendervalue.get(),em_contactvalue.get(),payment_modevalue.get(),foodservice_value.get()}\n")
